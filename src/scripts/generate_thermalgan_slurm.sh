...
DATA_DIR=../../data/Non_ortologus #ALL_FAMILIES #Experiment_11137_thermo
...
CONFIG=../../results/Models_used_in_experiments/Batch_4_models2/config.yaml #${DATA_DIR}/config/config_all_${SLURM_ARRAY_TASK_ID}.yaml #../..//results/20240216-124423config_0.yaml/config.yaml #${DATA_DIR}/config/config_all_${SLURM_ARRAY_TASK_ID}.yaml
